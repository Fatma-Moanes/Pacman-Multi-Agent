...
class Directions:       # All the possible movements (left /right /reverse)
    NORTH = 'North'
    SOUTH = 'South'
    EAST = 'East'
    WEST = 'West'
...
class Configuration:  # gets the pos & dir, can determine the next pos & dir (the direction taken to get to that pos)
    """
